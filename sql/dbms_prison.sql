...
cno`,
`cname
`, `DOB`, `sex`, `starting_date`, `caddress`, `assigned_cellno`) VALUES
...
gno`,
`gname
`, `DOB`, `address`, `starting_date`, `sex`, `assigned_block`, `shift`, `password`) VALUES
...
pno`,
`Name
`, `admit_date`, `DOB`, `address`, `crime`, `sex`, `ptype`, `duration`, `cellno`) VALUES
