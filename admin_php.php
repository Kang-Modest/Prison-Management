...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="noinput" type="text" placeholder="eg: Modest" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="passinput" type="text" placeholder="eg: Modest123" class="form-control input-md">
